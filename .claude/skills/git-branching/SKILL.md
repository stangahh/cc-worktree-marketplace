...
When committing on the created branch, reference the ticket:

- `feat: add user login (PROJ-123)`
- `fix: resolve session timeout (PROJ-105)`
- `refactor: simplify auth API (PROJ-108)`

Use closing keywords in commit body when appropriate:
